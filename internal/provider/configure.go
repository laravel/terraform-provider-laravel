...
// resourceWithClient supplies the Configure method every resource shares.
// Embed it instead of declaring a client field.
...
// dataSourceWithClient is the data source counterpart of resourceWithClient.
